...
plot( y[1:500, :]', color=1, legend=false , alpha=0.05)
plot!( y[501:end, :]', color=2, legend=false, alpha=0.05) 
xticks!(1:11)

plot!( mean(y[1:500, :], dims=1)', color=1, lw=3)
plot!(mean(y[501:end, :], dims=1)', color=2, lw=3)
